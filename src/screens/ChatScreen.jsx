...
function detectReplyLanguage(text, langPreference) {
  ...
  const isMarathi =
    /[ळऱ]/.test(text) ||
    /पाऊस|पावसा|हवामान|गारठा|छत्री|थंडी|ऊन|वारा|पडेल|वादळ|धुके|घेऊन|जाऊ|आहे|नाही|लागेल|करावे|करायचे|जाणे|योग्य|का|नको|असेल|होईल|कसा|कशी|कसे|काय|आहेत|शकतो|शकते|पाहिजे|जायचे|न्यावे|खेळू|सफर|प्रवास|बाहेर/.test(text) ||
...
const WEATHER_FAIL_FALLBACK = {
  hi: 'क्षमा करें, मैं अभी आपका अनुरोध संसाधित नहीं कर सका। कृपया पुनः प्रयास करें।',
  mr: 'एआय उत्तर आले नाही, पण खाली तुमच्या भागातील लाइव्ह हवामान दिले आहे.',
  ta: 'AI பதில் இப்போது வரவில்லை, ஆனால் கீழே உங்கள் நேரடி வானிலை உள்ளது.',
  te: 'AI సమాధానం రాలేదు, కానీ కింద మీ ప్రాంత లైవ్ వాతావరణం ఉంది.',
  bn: 'দুঃখিত, এখন আপনার অনুরোধ প্রক্রিয়া করতে পারিনি। আবার চেষ্টা করুন।',
}
...
const WEATHER_FAIL_NO_DATA = {
  ...
  mr: 'एआय उत्तर आले नाही. हवामान डेटा उपलब्ध नाही — कृपया तुमचे कनेक्शन तपासा.',
  ta: 'AI பதில் வரவில்லை. வானிலை தரவும் இல்லை — உங்கள் இணைப்பை சரிபார்க்கவும்.',
  te: 'AI సమాధానం రాలేదు. వాతావరణ డేటా కూడా లేదు — మీ కనెక్షన్ తనిఖీ చేయండి.',
  bn: 'এআই উত্তর আসেনি। আবহাওয়ার তথ্যও নেই — আপনার সংযোগ পরীক্ষা করুন।',
}
...
const GENERAL_FAIL_FALLBACK = {
  ...
  ta: 'மன்னிக்கவும், இப்போது உங்கள் கோரிக்கையை செயலாக்க முடியவில்லை. மீண்டும் முயற்சிக்கவும்.',
  te: 'క్షమించండి, ఇప్పుడు మీ అభ్యర్థనను ప్రాసెస్ చేయలేకపోयाను. దయచేసి మళ్ళీ ప్రయత్నించండి.',
  bn: 'দুঃখিত, এখন আপনার অনুরোধ প্রক্রিয়া করতে পারিনি। আবার চেষ্টা করুন।',
}
...
const NEED_LOCATION_FALLBACK = {
  ...
  hi: 'मौसम के लिए स्थान चाहिए। वापस जाकर GPS या शहर का नाम दर्ज करें।',
  mr: 'हवामानासाठी स्थान हवे आहे. परत जाऊन GPS किंवा शहर नाव द्या.',
  ta: 'வானிலைக்கு உங்கள் இடம் தேவை. GPS அல்லது நகரப் பெயரை உள்ளிடவும்.',
  te: 'వాతావరణానికి మీ స్థానం కావాలి. GPS లేదా నగరం పేరు ఇవ్వండి.',
  bn: 'আবহাওয়ার জন্য আপনার অবস্থান লাগবে। GPS বা শহরের নাম দিন।',
}
    ...
    try {
      ...
      return {
        text: replyLang === 'en'
          ...
          : `NWP मॉडेल अंदाज सध्या उपलब्ध नाही: ${err.message}`,
        card: null,
      }
    }
  }
    ...
    try {
      ...
      return {
        text: replyLang === 'en'
          ...
          : `जलवायु रुझान डेटा अभी उपलब्ध नहीं है: ${err.message}`,
        card: null,
      }
    }
  }
    ...
    try {
      ...
      if (typeof historicalData !== 'undefined' && historicalData) {
        ...
        if (replyLang === 'en') {
          ...
          // Hindi fallback
          fallbackText = `पिछले ${historicalData.thisYear.daysAnalyzed} दिन पिछले साल की तुलना में ${Math.abs(tempDiff)}°C अलग थे।`
        }
      ...
      return {
        text: replyLang === 'en'
          ...
          : 'ऐतिहासिक हवामान डेटा सध्या उपलब्ध नाही. कृपया सद्य हवामानाबद्दल विचारा.',
        card: null,
      }
    }
  }
